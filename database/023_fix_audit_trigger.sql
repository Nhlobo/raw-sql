...
Fixes audit trigger failures caused by referencing non-existent fields like
NEW.id / OLD.id on tables that use different primary key column names.

This version safely extracts possible entity IDs from trigger records using
to_jsonb(...), which avoids runtime errors when a field does not exist.
===============================================================================
*/
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '===========================================================';
    RAISE NOTICE 'Audit trigger fix applied';
    RAISE NOTICE '024_fix_audit_trigger.sql COMPLETED';
    RAISE NOTICE '===========================================================';
    RAISE NOTICE '';
END;
$$;
