...
(
    ...
    examiner_notes TEXT,
    completed_by UUID,
    completed_at TIMESTAMPTZ DEFAULT core.utc_now()
);
...
(
    ...
    joint_instability BOOLEAN DEFAULT FALSE,
...
(
    ...
    spinal_cord_injury BOOLEAN DEFAULT FALSE,
...
(
    ...
    ama_edition VARCHAR(30) NOT NULL DEFAULT 'AMA Guides 6th Edition',
    impairment_method VARCHAR(120),
    upper_extremity_percentage NUMERIC(5,2) DEFAULT 0,
    lower_extremity_percentage NUMERIC(5,2) DEFAULT 0,
    spinal_impairment_percentage NUMERIC(5,2) DEFAULT 0,
    neurological_percentage NUMERIC(5,2) DEFAULT 0,
    psychiatric_percentage NUMERIC(5,2) DEFAULT 0,
    visual_percentage NUMERIC(5,2) DEFAULT 0,
    hearing_percentage NUMERIC(5,2) DEFAULT 0,
    respiratory_percentage NUMERIC(5,2) DEFAULT 0,
    cardiovascular_percentage NUMERIC(5,2) DEFAULT 0,
    skin_percentage NUMERIC(5,2) DEFAULT 0,
    digestive_percentage NUMERIC(5,2) DEFAULT 0,
    urinary_percentage NUMERIC(5,2) DEFAULT 0,
    reproductive_percentage NUMERIC(5,2) DEFAULT 0,
    combined_impairment_percentage NUMERIC(5,2) NOT NULL,
    final_whole_person_impairment NUMERIC(5,2) NOT NULL,
...
(
    ...
    drafted_by UUID,
    drafted_at TIMESTAMPTZ DEFAULT core.utc_now()
);
...
(
    ...
    generated_file UUID,
    generated_by UUID,
    generated_at TIMESTAMPTZ DEFAULT core.utc_now(),
