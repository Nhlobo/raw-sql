...
- **Secrets:** configure `JWT_ACCESS_SECRET`, `JWT_REFRESH_SECRET`, `COOKIE_SECRET`, `CSRF_SECRET`, `RESEND_API_KEY`, `EMAIL_FROM`, `FRONTEND_URL`, `API_URL`, `SUPER_ADMIN_EMAIL`, and `SUPER_ADMIN_PASSWORD`
